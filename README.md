...
sidebar-avatar: /img/king.jpg     #你的大头贴，请使用绝对地址.注意：名字区分大小写！后缀名也是
```
...
我的博客标题是 **“ KeQian Blog”** 但是我想要在搜索的时候显示 **“KeQian的博客 | King's Blog”** ，这个就需要 SEO Title 来定义了。
...
遵循 MIT 许可证。有关详细,请参阅 [LICENSE](https://github.com/KeQianWang/KeQianWang.github.io/blob/master/LICENSE)。
